...
async function createAsset(algodClient, alice) {
    ...
    console.log("Trainee's account balance: %d microAlgos", startingAmount);
...
//    const metadatafile = (await fs.readFileSync(fullPath)).toString();
    ...
    const fullPathImage = __dirname + '/NFT/crt.jpg';
...
async function createNFT() {
    ...
    try {
        // uncomment the following 2 lines to create ur own account
        ...
        // uncomment the following 4 lines to create ur own account
        ...
        //uncomment the following 4 lines to use purestake API
